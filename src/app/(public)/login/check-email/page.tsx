  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-[var(--fb-gutter)] py-16">
      ...
      <p className="mt-3 text-sm text-[var(--fb-text-muted)]">
        Wenn die Adresse stimmt, liegt der Link zum Tippen im Posteingang. Manchmal rutscht
        er in den Spam-Ordner. Der Link ist nur kurz gültig und nur einmal nutzbar.
      </p>
      <Link
        href="/login?next=/tools/tippspiel"
